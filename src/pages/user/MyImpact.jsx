...
export default function MyImpact() {
  ...
  useEffect(() => {
    const fetchImpact = async () => {
      try {
        ...
        console.error(err)
        setError(
          'Unable to load your impact data.'
        )
      } finally {
        setLoading(false)
      }
  ...
  const impactScore = Number(
    impactData.impact_score ??
    impactData.impact_progress ??
    0
  )
  ...
  const totalItems = Number(
    impactData.total_items ?? 0
  )

  const impactGrowth = Number(
    impactData.impact_growth ?? 0
  )
  ...
  const impactAreas = (
    impactData.impact_areas || []
  ).map((area) => {
    const category = area.category || 'Other'
    const items = Number(area.items ?? 0)
    ...
    return {
      ...
      description:
        ...
        } submitted in this donation category.`,
    ...
    <div className="min-h-screen bg-mist">
      ...
      <header className="border-b border-cloudline bg-white">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 sm:px-8 lg:px-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/user-dashboard"
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-slate-muted transition-all duration-200 hover:bg-mist hover:text-deepsea"
      ...
      <main className="px-6 py-8 sm:px-8 lg:px-10 lg:py-10">
        ...
        <div className="mx-auto max-w-7xl">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm leading-relaxed text-slate-muted sm:text-base">
                  Track the donations and items you have submitted through HopeCloud.
                </p>
          ...
          <section className="relative overflow-hidden rounded-[28px] bg-deepsea p-7 text-white shadow-soft sm:p-9 lg:p-10">
            ...
            <div className="relative z-10 grid gap-10 lg:grid-cols-[1fr_280px] lg:items-center">
              ...
              <div>
                ...
                <p className="mt-4 max-w-2xl text-sm leading-relaxed text-blue-100 sm:text-base">
                  Your impact score is calculated from the donation items you have submitted through your HopeCloud account.
                </p>
                  ...
                  <span>
                    {impactScore >= 90
                      ...
                      : `${Math.max(
                        0,
                        90 - impactScore
                      )} points away from the current Hope Champion threshold.`}
                  </span>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            {impactStats.map((stat) => {
              ...
              return (
                <div
                  key={stat.label}
                  className="group rounded-2xl border border-cloudline bg-white p-5 shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-soft"
                >
              ...
              <div className="grid gap-5 lg:grid-cols-3">
                ...
                {impactAreas.map((area) => {
                  ...
                  return (
                    <div
                      key={area.title}
                      className="rounded-2xl border border-cloudline bg-white p-6 shadow-card transition-all duration-300 hover:-translate-y-1 hover:shadow-soft"
                    >
            ...
            <div className="divide-y divide-cloudline">
              ...
              {recentImpact.length === 0 ? (
                ...
                recentImpact.map((item) => (
                  ...
                  <div
                    key={item.id}
                    className="flex flex-col gap-4 p-5 transition-colors hover:bg-mist/60 sm:flex-row sm:items-center sm:justify-between sm:px-6"
                  >
          ...
          <section className="mt-8 rounded-2xl border border-sky-100 bg-gradient-to-r from-sky-50 to-white p-6 sm:p-7">
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-xl text-xs leading-relaxed text-slate-muted">
                    Every submitted donation increases your contribution activity and can increase your impact score.
                  </p>
              ...
              <Link
                to="/donate"
                className="inline-flex shrink-0 items-center justify-center gap-2 rounded-full bg-deepsea px-5 py-3 text-xs font-bold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-sky-600 hover:shadow-glow"
              >
